...
class SSDTrainResize(object):

    def __init__(self, height, width, net=None, mean=[0.485, 0.456, 0.406],
                 std=[0.229, 0.224, 0.225], foreground_iou_thresh=0.5, make_target=True, image_normalization=True):
...
if __name__ == "__main__":
    ...
    dataset = dataset.transform(SSDTrainTransform(input_size[0], input_size[1], make_target=False,
