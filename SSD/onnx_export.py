...
import numpy as np
from core import SSD_VGG16_Except_Anchor, AnchorNet, export_block_for_cplusplus
...
def export(originpath="weights",
           ...
           load_name="512_512_ADAM_PVGG16_512", load_period=1,
           target_size=(768, 768),
    ...
    anchornet = AnchorNet(net=net, version=version, box_sizes300=box_sizes300, box_ratios300=box_ratios300,
                          box_sizes512=box_sizes512, box_ratios512=box_ratios512, anchor_box_clip=anchor_box_clip,
...
if __name__ == "__main__":
    export(originpath="weights", newpath="onnxweights", load_name="512_512_ADAM_PVGG16_512", load_period=1,
           target_size=(768, 768),
           box_sizes300=[21, 45, 101.25, 157.5, 213.75, 270, 326.25],
           box_ratios300=[[1, 2, 0.5]] +  # conv4_3
                         [[1, 2, 0.5, 3, 1.0 / 3]] * 3 +  # conv7, conv8_2, conv9_2, conv10_2
