...
anchor_sizes = parser["anchor_sizes"]
anchor_size_ratios = eval(parser["anchor_size_ratios"])
anchor_aspect_ratios = parser["anchor_aspect_ratios"]
...
background_iou_thresh = parser["background_iou_thresh"]
...
if __name__ == "__main__":
    ...
    if training:
        if using_mlflow:
            ...
            ml.set_experiment("Efficient" + "_" + str(base))
